...
public class DeleteItemStock extends RESTMethod<ItemStock> {
	...
	public interface DeleteItemStockCallback {
	    public void onDeleteItemStock(ItemStock result);
	    public void onFailDeleteItemStock(com.trubeacon.cloverandroidapi.client.error.Error error);
	}

	public DeleteItemStock(String merchantId, String token, String itemStockId) {
	...
	public void execute(final DeleteItemStockCallback callback) {
	    super.execute(new Callback<ItemStock>() {
	        @Override
	        public void onReceiveResult(ItemStock result) {
	            if (callback != null) {
	                callback.onDeleteItemStock(result);
	            }
	        }
	        @Override
	        public void onReceiveError(com.trubeacon.cloverandroidapi.client.error.Error error) {
	            if (callback != null) {
	                callback.onFailDeleteItemStock(error);
	            }
	        }
	    });
	}
