...
public class GetOrderType extends RESTMethod<OrderType> {

	private static final String URL = "/merchants/{merchantId}/order_types/{orderTypeId}";
	private static final HttpMethod METHOD = HttpMethod.GET;
	
	public interface GetOrderTypeCallback {
	    public void onGetOrderType(OrderType result);
	    public void onFailGetOrderType(com.trubeacon.cloverandroidapi.client.error.Error error);
	}

	public GetOrderType(String merchantId, String token, String orderTypeId) {
	...
	public void execute(final GetOrderTypeCallback callback) {
	    super.execute(new Callback<OrderType>() {
	        @Override
	        public void onReceiveResult(OrderType result) {
	            if (callback != null) {
	                callback.onGetOrderType(result);
	            }
	        }
	        @Override
	        public void onReceiveError(com.trubeacon.cloverandroidapi.client.error.Error error) {
	            if (callback != null) {
	                callback.onFailGetOrderType(error);
	            }
	        }
	    });
	}
